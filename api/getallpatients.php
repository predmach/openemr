...
if ($userId = validateToken($token)) {
    ...
    if ($acl_allow) {
        ...
        $strQuery = "SELECT id, pid, fname as firstname, lname as lastname,mname as middlename, phone_contact as phone, dob, sex as gender FROM patient_data limit 0,10";
        ...
        if ($numRows > 0) {
            ...
            while ($res = sqlFetchArray($result)) {
                ...
                $strQuery1 = "SELECT d.date,d.size,d.url,d.docdate,d.mimetype,c2d.category_id
                                ...
                                WHERE foreign_id = ?
                                AND category_id = 10    /*Changed Category From 13 to 10 */
